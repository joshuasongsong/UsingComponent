...
class MovableImageView(_context: Context,_attrs: AttributeSet) : ImageView(_context,_attrs)
{
    init
    {
    ...
    private val MIN_ZOOM_POINTER = 5.0
    ...
    private fun touchMove(event: MotionEvent)
    {
        ...
        else if (this.operationMode == OperationMode.ZOOM)
        {
            ...
            if (deltaDistance > MIN_ZOOM_POINTER)
            {
